...
"MSWin32-x64-multi-thread-10.0.20348.4529" or
	die "Errno architecture (MSWin32-x64-multi-thread-10.0.20348.4529) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
